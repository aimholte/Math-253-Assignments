...
payments/amounts #What fraction of loan amounts are paid
...
amounts*(1+rate/100) - amounts #The average amount we will make per loan
(amounts*(1+rate/100) - amounts)* (9798+70) #The expected amount we will make in total if we loan to everyone
```
